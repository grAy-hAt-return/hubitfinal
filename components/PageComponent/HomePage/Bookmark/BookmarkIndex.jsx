        ...
        <div className='w-[95%] grid xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-1  grid-cols-1 py-5'>
            {data.map((val,i)=>{
                return <div key={i} className={`${i===1 ? 'xl:border-x-2 lg:border-x-2' : ""} xl:px-11 lg:px-11 px-4 pb-5`}>
                        ...
                        <p className='xl:max-w-[35ch] lg:max-w-[35ch] w-full xl:text-base lg:text-base md:text-base sm:text-sm text-xs xl:font-normal lg:font-normal md:font-normal font-medium  text-justify leading-5'>
                            {val.p}
                        </p>
                </div>
            })}
