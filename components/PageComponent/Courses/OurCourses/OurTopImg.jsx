  ...
  return (
    ...
    style={{
        ...
        <div className='w-11/12 mx-auto'>
            <h1 className='xl:text-3xl lg:text-2xl md:text-xl text-xl font-semibold tracking-wide text-zinc-50 lg:mb-8 md:mb-6 sm:mb-4 mb-3'>Our Courses
            </h1>
            <h1 className='text-zinc-50 md:text-sm text-xs lg:text-base xl:text-base'>Home/Courses</h1>
        </div>
      </div>
    </div>
  );
