...
const MidSection = () => {
  ...
  const numbers = [1, 2];
  return (
    <div className=" px-4 md:px-28 lg:px-24 xl:px-28 xxl:px-28 md:py-20 lg:py-20 xl:py-20 xxl:py-20 py-12">
      {/* <MidSectionNav />
      <div classNameName="flex flex-col gap-2 items-center justify-center">
        {[1, 2, 3, 4].map((item, i) => {
          return (
        ...
        <div>
          {Data.map((val, i) => {
            return (
              <div key={i}>
                <div className="md:flex lg:flex xl:flex xxl:flex gap-10 items-start mb-10">
                  <div className="w-[360px] md:w-[250px] lg:w-[230px] xl:w-[250px] xxl:w-[300px] mb-5 md:mb-0 lg:mb-0 xl:mb-0 xxl:mb-0 ">
                    <Image
                      src={val.image}
                      layout="responsive"
                      height={350}
