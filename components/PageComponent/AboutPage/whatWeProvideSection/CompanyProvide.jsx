...
function CompanyProvide({ icon, title, description }) {
  return (
    <div className={`transition-all duration-200 ease-linear hover:border-b-2  hover:border-b-main shadow-gray-200 px-16 pt-5 pb-16 `}>
      ...
      <div className="Poppins text-xs text-gray-500 font-regular leading-5 text-justify mt-5 scroll overflow-scroll">
        {" "}
        {description}
      </div>
    </div>
