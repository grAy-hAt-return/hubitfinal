...
const ContentSection = () => {
  ...
  return (
    <section className=" mt-8">
      ...
      <div className="w-11/12 px-4 sm:px-6 md:px-0 lg:px-0 xl:px-0 xxl:px-0 mx-auto mt-4">
        <h2 className="text-main mx-0 pb-5 text-lg md:text-xl lg:text-2xl xl:text-2xl xxl:text-2xl">Sake and Benefits</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 xxl:grid-cols-2 md:gap-4 lg:gap-2 xl:gap-2 xxl:gap-2">
          {benefits.map((benefit) => {
            return (
              <>
                <div className="flex justify-center items-center align-center mb-6 text-black text-lg font-medium">
                  <BsCheckCircle key={benefit} className="text-2xl xxl:text-3xl mr-2 font-bold" />
                  <p className="text-sm md:text-base xl:text-base xxl:text-base lg:text-base ">
