  ...
  return (
    <div className='w-full h-screen'>
        <div className='w-full h-full relative flex items-center justify-center overflow-clip'>
            <div className='w-5/6 h-5/6 mx-auto flex relative z-10 rounded-md overflow-clip bg-white shadow-purple shadow-lg'>
                <div className='w-full md:w-3/5 lg:w-3/5 xl:w-3/5 xxl:w-3/5 h-full relative bg-gradient-to-b text-zinc-50 from-violet-900 from-70% via-purple via-10% to-pink-600 to-20%'>
                    <Formik 
                    initialValues={{
                        NameOfInstitute:"",
                        AddressOfInstitute:"",
                     ...
                     className='w-full h-full'>
                        {({handleSubmit})=>{
                            return <Form onSubmit={handleSubmit}>
                                <div className={`w-full h-full px-2 md:px-3 lg:px-4 xl:px-4 xxl:px-5 border-0 py-5`}>
                                <h1 className='w-full h-full font-bold  text-center text-xl md:text-2xl lg:text-2xl xl:text-3xl xxl:text-3xl my-0'>
                                        Sign in
                                    </h1>
                                    <div className='w-full my-5 flex flex-wrap justify-evenly'>
                                    {formdata.map((val,i)=>{
                                        return <div key={i} className={`${val.type === 'email' ? 'w-[30%]':'w-full'} ${val.identity === 'ContactNumber' ? 'w-[30%]':'w-full'} flex flex-col  xxl:my-3`}>
                                            <label className='text-sm md:text-base lg:text-base xl:text-base xxl:text-base font-medium mb-2'>
                                                {val.label}
                                            </label>
                                            <Field 
                                            type={val.type}
                                    ...
                                    <div className='w-full flex items-center justify-center mt-10'>
                                        <button className='w-16 md:w-20 lg:w-24 xxl:w-28  md:h-8 lg:h-10 xxl:h-10 text-center capitalize text-sm md:text-base lg:text-base xl:text-base xxl:text-base font-medium text-white hover:text-purple bg-purple hover:bg-white border-purple border-2 transition-all duration-200 rounded-md'>
                                            Sign up
                                        </button>
                                    </div>
                                </div>
                ...
                <div className='hidden w-0 md:block lg:block xl:block xxl:block md:w-2/5 lg:w-2/5 xl:w-2/5 xxl:w-2/5 h-0 md:h-full lg:h-full xl:h-full xxl:h-full bg-[url(https://scontent.fbwa1-1.fna.fbcdn.net/v/t39.30808-6/274578238_3124516784501038_7802018382545889587_n.jpg?_nc_cat=100&ccb=1-7&_nc_sid=efb6e6&_nc_ohc=J2-LVuWn8QcAX83zkM6&_nc_ht=scontent.fbwa1-1.fna&oh=00_AfATvdeVpLspAwpwz63Ea6F-iioXb4nPaAqck_NtU4vVzw&oe=657A3D59)] bg-contain bg-center bg-no-repeat'>
                </div>
            </div>
            ...
            <div className='w-20 h-20 absolute top-1 right-96 flex justify-center items-center text-4xl animate-swing transition-all duration-500 delay-300 text-purple'>
                <RiComputerLine />
            </div>
            ...
            <div className='w-fit h-fit absolute top-2 left-1/4 flex justify-center items-center text-5xl animate-spinopp transition-all duration-500 delay-300 text-cyan-600'>
                <FaPython />
            </div>
