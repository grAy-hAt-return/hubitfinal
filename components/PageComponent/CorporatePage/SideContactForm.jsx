...
const SideContactForm = () => {
  return (
    <>
      <div className="w-30 mt-3  xs:ml-10 sm:ml-12 md:ml-14 md:mb-3  ">
        ...
        <button className="bg-main py-2 px-6 w-48   rounded-[100px] text-lg sm:w-44 xs:w-44 first-letter:mb-5  text-white hover:shadow-[inset_13rem_0_0_0] hover:shadow-hoverMain duration-[400ms,700ms] transition-[color,box-shadow] ">
          Send Message{" "}
        </button>
      </div>
    </>
